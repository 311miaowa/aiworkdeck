...
@file_bp.route('/edited_pptx/<filename>', methods=['GET'])
def serve_edited_pptx(filename):
    """
    GET /files/edited_pptx/{filename} - Serve edited PPTX files
    
    Args:
        filename: File name of the edited PPTX
    """
    try:
        safe_filename = secure_filename(filename)
        file_dir = os.path.join(
...
@file_bp.route('/standalone_edits/<filename>', methods=['GET'])
def serve_standalone_edit(filename):
    """
    GET /files/standalone_edits/{filename} - Serve standalone edited images
    
    Args:
        filename: File name of the edited image
    """
    try:
        safe_filename = secure_filename(filename)
        file_dir = os.path.join(
